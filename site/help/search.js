...
var IDX = [
  ...
  { page:'Workflows', url:'/help/workflows/silver-ui.html', anchor:'overview',
    ...
    text:'UI and frontend workflow with design tooling integration. Starts with silver:intel and product-brainstorming. Includes silver:brainstorm for design exploration, gsd-ui-phase for structured UI planning, and design:accessibility-review in the UI quality step. Full quality gates security and code review.' },
  ...
  { page:'Skills', url:'/help/reference/', anchor:'sb-skills',
    title:'Orchestration skills — silver:brainstorm-idea, silver:feature, silver:bugfix, silver:ui, silver:devops, silver:research, silver:release, silver:fast',
    text:'Eight named orchestration workflows: /silver:brainstorm-idea for idea-to-milestone intake, /silver:feature for feature development, /silver:bugfix for bug investigation and fixes, /silver:ui for UI/UX work, /silver:devops for infrastructure and DevOps tasks, /silver:research for research and exploration, /silver:release for release preparation, /silver:fast for quick low-overhead tasks. Invoked directly or routed automatically by /silver.' },
