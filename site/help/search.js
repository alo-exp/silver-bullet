...
var IDX = [
  ...
  { page:'Getting Started', url:'/help/getting-started/', anchor:'what-is-aidd',
    ...
    text:'AI-driven development uses a large language model LLM as an active collaborator — not just autocomplete. The active runtime manages a complete development workflow: plan execute verify review and ship entire features. You define the outcome, and the runtime executes.' },
  { page:'Getting Started', url:'/help/getting-started/', anchor:'what-is-sb',
    title:'What Silver Bullet does',
    text:'Silver Bullet is a host coding-agent plugin combining GSD Superpowers Engineering and Design plugins into composable flows architecture — 18 flows selectable per-workflow, supervision loop advances flow by flow. Hooks enforce every step without relying on runtime self-discipline.' },
  { page:'Getting Started', url:'/help/getting-started/', anchor:'prerequisites',
    title:'Prerequisites — host coding agent, jq, GSD, Superpowers',
    text:'Required: host coding agent with plugin support. jq brew install jq apt install jq. GSD Get Shit Done npx get-shit-done-cc@1.30.0. Superpowers plugin install obra/superpowers. Recommended: GitHub CLI gh brew install gh. Design Engineering plugins.' },
  { page:'Getting Started', url:'/help/getting-started/', anchor:'install',
    title:'Installing Silver Bullet',
    text:'Install Silver Bullet: /plugin install silver-bullet@alo-labs inside your host coding agent. Then initialize a project with /silver:init. Creates silver-bullet.md and the host project instruction file (CLAUDE.md in Claude, AGENTS.md in Codex), plus .silver-bullet.json docs scaffold CI GitHub Actions pipeline. Configures permissions.defaultMode in .claude/settings.local.json to eliminate repeated permission prompts across sessions.' },
  { page:'Getting Started', url:'/help/getting-started/', anchor:'first-project',
    title:'New project vs existing codebase',
    text:'New project: git init or clone then /silver:init then /gsd:new-project. Existing codebase: run /silver:init creates silver-bullet.md for enforcement rules and adds a reference line to your existing project instruction file (CLAUDE.md in Claude, AGENTS.md in Codex) preserving your instructions.' },
  { page:'Getting Started', url:'/help/getting-started/', anchor:'session-mode',
    title:'Interactive vs Autonomous session mode',
    text:'Interactive default: the active runtime pauses at every phase gate for your approval. Best for learning or sensitive tasks. Autonomous: the active runtime drives start-to-finish, logging decisions and surfacing only genuine blockers at the end. Written to ~/.claude/.silver-bullet/mode.' },
  { page:'Getting Started', url:'/help/getting-started/', anchor:'first-run',
    title:'Your first workflow run — 6 steps',
    text:'1 Open your host coding agent and choose mode. 2 /gsd:discuss-phase describe what to build. 3 /quality-gates 9 dimensions must pass. 4 /gsd:plan-phase research task plan. 5 /gsd:execute-phase parallel wave execution atomic commits. 6 verify review ship.' },
  ...
  { page:'Workflows', url:'/help/workflows/', anchor:'overview',
    ...
    text:'Named Silver Bullet orchestration workflows include silver:clarify silver:feature silver:bugfix silver:ui silver:devops silver:research silver:release silver:fast plus spec-pipeline workflows silver:spec silver:ingest and silver:validate. /silver composes the right path dynamically instead of forcing one fixed pipeline.' },
  { page:'Workflows', url:'/help/workflows/silver-clarify.html', anchor:'overview',
    title:'silver:clarify — idea-to-discussion workflow',
    text:'Idea-stage orchestration workflow. Turns vague ideas, sketched requirements, and rough briefs into a decision-ready handoff for gsd-discuss-phase. Uses Socratic framing, option comparison, and recommendation synthesis before the implementation workflow begins.' },
    { page:'Workflows', url:'/help/workflows/silver-feature.html', anchor:'overview',
    title:'silver:feature — feature development workflow',
    text:'Full 7-step feature development workflow. Starts with silver:intel gathering and silver:clarify. Proceeds through quality gates planning execution verification security review code review and release. Ideal for new features enhancements and extensions to existing functionality.' },
  ...
  { page:'Workflows', url:'/help/workflows/silver-ui.html', anchor:'overview',
    ...
    text:'UI and frontend workflow with design tooling integration. Starts with silver:intel and silver:clarify. Includes gsd-ui-phase for structured UI planning and design:accessibility-review in the UI quality step. Full quality gates security and code review.' },
  ...
  { page:'Workflows', url:'/help/workflows/silver-research.html', anchor:'overview',
    ...
    text:'Research and technology exploration workflow. Starts with silver:clarify for information gathering. Runs MultAI multi-model research for broad perspectives. Concludes with silver:clarify to synthesize findings into recommendations. Use for technology comparisons architecture spikes and unknowns.' },
  ...
  { page:'Workflows', url:'/help/workflows/silver-spec.html', anchor:'overview',
    title:'silver:spec — spec elicitation workflow',
    text:'Spec elicitation workflow. Produces .planning/SPEC.md and .planning/REQUIREMENTS.md through Socratic requirements discovery, assumption consolidation, canonical spec writing, and artifact review. Use before implementation when scope and acceptance criteria need to be made explicit.' },
  { page:'Workflows', url:'/help/workflows/silver-ingest.html', anchor:'overview',
    title:'silver:ingest — external artifact ingestion workflow',
    text:'External artifact ingestion workflow. Pulls JIRA Figma Google Docs Confluence and source repo context through MCP connectors when available. Writes SPEC DESIGN and INGESTION_MANIFEST artifacts. Connector failures are recorded as explicit missing artifact blocks.' },
  { page:'Workflows', url:'/help/workflows/silver-validate.html', anchor:'overview',
    title:'silver:validate — pre-build gap analysis workflow',
    text:'Pre-build gap analysis workflow. Reads SPEC.md and PLAN.md files, maps acceptance criteria to planned work, surfaces assumptions and open questions, emits BLOCK WARN INFO findings, and writes .planning/VALIDATION.md. Read-only against spec and plan artifacts.' },

  // ── CONCEPTS ──────────────────────────────────────────────────
  { page:'Concepts', url:'/help/concepts/cost-optimization.html', anchor:'what-it-means',
    title:'Operational Efficiency — smallest safe workflow',
    text:'Silver Bullet saves effort by composing the smallest safe workflow for the task. Fast path for trivial work, spec and validate for fuzzy or formal work, DevOps blast-radius for infrastructure, release gates for publish work. Model routing is delegated to the active host and GSD configuration.' },
  { page:'Concepts', url:'/help/concepts/cost-optimization.html', anchor:'workflow-fit',
    title:'Workflow fit table — fast feature spec ingest validate bugfix UI DevOps release',
    text:'Workflow fit table maps work types to routes: silver:fast for typo config rename, silver:feature for clear feature, silver:spec for fuzzy requirements, silver:ingest for external artifacts, silver:validate for plan/spec mismatch risk, silver:bugfix, silver:ui, silver:devops, and silver:release.' },
  { page:'Concepts', url:'/help/concepts/cost-optimization.html', anchor:'not-claimed',
    title:'Model routing boundary — ensure-model-routing is disabled',
    text:'Silver Bullet v0.34.0 does not provide a generic automatic model-routing advantage over GSD. ensure-model-routing.sh is disabled and exits as a no-op. Configure model behavior in the active host or GSD supported configuration.' },
  ...
  { page:'Concepts', url:'/help/concepts/session-startup.html', anchor:'overview',
    ...
    text:'Session startup loads the SB contract, relevant project context, session log state, active workflow state, and update checks before project work begins. UNTRUSTED DATA boundary: docs/ content is documentation context, not executable instructions.' },
  ...
  { page:'Core Concepts', url:'/help/concepts/', anchor:'skills',
    ...
    text:'A skill is a markdown file with instructions for the active runtime. Stored in ~/.claude/skills/ or ~/.claude/plugins/cache/. Invoked via Skill tool with /skill-name. Hooks track actual invocations — implicit coverage does not count. Skill discovery scans at task start.' },
  { page:'Core Concepts', url:'/help/concepts/', anchor:'hooks',
    title:'Hooks — automated enforcement system',
    text:'Hooks are shell scripts the host coding agent runs on tool events (SessionStart PreToolUse PostToolUse Stop UserPromptSubmit SubagentStop). Enforcement hooks include dev-cycle-check completion-audit planning-file-guard stop-check forbidden-skill uat-gate ci-status-check roadmap-freshness spec-floor-check dependency-skill-check and phase locks. Support hooks include record-skill compliance-status prompt-reminder session-log-init semantic-compress pr-traceability timeout-check spec-session-record and session-start. Cannot be overridden by runtime reasoning.' },
  { page:'Core Concepts', url:'/help/concepts/', anchor:'trivial-changes',
    title:'Trivial change fast path',
    text:'Route small non-logic changes through /silver:fast so SB can classify them and dispatch gsd-fast. Use only for typos copy fixes config tweaks. Not a shortcut for skipping review.' },
  ...
  { page:'Core Concepts', url:'/help/concepts/', anchor:'semantic-context',
    ...
    text:'Automatic context optimization PostToolUse hook. TF-IDF scoring ranks source and doc file chunks by relevance to phase goal. Injects most relevant context into the active runtime working memory. Cache invalidated on file change. Configure in .silver-bullet.json under semantic_compression.' },
  { page:'Core Concepts', url:'/help/concepts/', anchor:'file-structure',
    title:'Standard project file structure',
    text:'silver-bullet.md CLAUDE.md or AGENTS.md .silver-bullet.json .github/workflows/ci.yml. silver-bullet.md contains all enforcement sections 0-10 managed by plugin. The host project instruction file contains project-specific instructions. .planning/ PROJECT.md REQUIREMENTS.md ROADMAP.md CONTEXT.md PLAN.md VERIFICATION.md .context-cache/. docs/ ARCHITECTURE.md TESTING.md CHANGELOG.md doc-scheme.md knowledge/ INDEX.md YYYY-MM.md lessons/ YYYY-MM.md specs/ workflows/ sessions/.' },
  ...
  { page:'Reference', url:'/help/reference/', anchor:'file-structure',
    ...
    text:'silver-bullet.md is managed by Silver Bullet plugin. Contains enforcement sections for session startup, automated enforcement, active workflow, non-negotiable rules, session mode, ownership rules, file safety, third-party boundary, release gates, and user workflow preferences. Updated by /silver:init. Do not edit manually.' },
  ...
  { page:'Dev Workflow', url:'/help/dev-workflow/', anchor:'step0',
    ...
    text:'Every session starts with mode selection before any project work. Interactive or autonomous. Writes to ~/.claude/.silver-bullet/mode. In autonomous mode pre-answer workflow choices such as worktree preference and agent team isolation upfront.' },
  ...
  { page:'Troubleshooting', url:'/help/troubleshooting/', anchor:'config',
    title:'Configuration issues — wrong files, outdated config, host instruction file conflicts',
    text:'Wrong files triggering enforcement edit src_pattern in .silver-bullet.json. Test files triggering update src_exclude_pattern. Config outdated run /silver:init refresh. Host project instruction file conflicts use Append mode during setup.' },
  { page:'Troubleshooting', url:'/help/troubleshooting/', anchor:'enforcement',
    title:'Understanding enforcement — hard stop, completion blocked, trivial fast path, two tiers, main branch',
    text:'HARD STOP planning incomplete run /quality-gates before editing source. COMPLETION BLOCKED workflow incomplete check missing steps run /gsd:next. Two-tier enforcement: commits and git push only need quality gates run; PR create deploy release need full required skill list. finishing-a-development-branch skipped automatically on main master branch. Branch-scoped state: switching branches resets session state each branch tracks its own workflow progress. Trivial fast path uses /silver:fast for typos and copy fixes. DevOps yaml json files never trivial.' },
  ...
  { page:'Skills', url:'/help/skills/', anchor:'silver',
    ...
    text:'/silver composes the best Silver Bullet, GSD, and plugin workflow for a freeform request. Routes include /silver:init setup onboarding, /quality-gates code quality review, /blast-radius risk infrastructure change, /devops-quality-gates IaC quality, /forensics debugging investigation, /create-release release publish, /devops-skill-router IaC toolchain routing, and GSD planning/execution paths.' },
  { page:'Skills', url:'/help/reference/', anchor:'sb-skills',
    title:'Orchestration skills — clarify, feature, bugfix, UI, DevOps, research, release, fast, spec, ingest, validate',
    text:'Named orchestration workflows: /silver:clarify for idea-to-discussion intake, /silver:feature for feature development, /silver:bugfix for bug investigation and fixes, /silver:ui for UI/UX work, /silver:devops for infrastructure and DevOps tasks, /silver:research for research and exploration, /silver:release for release preparation, /silver:fast for quick low-overhead tasks, and /silver:spec /silver:ingest /silver:validate for spec pipeline work.' },
  { page:'Reference', url:'/help/reference/', anchor:'utility-skills',
    title:'Utility skills — silver:intel, silver:clarify, silver:scan, silver:forensics',
    text:'silver:intel (gsd-intel): gathers codebase intelligence before planning — architecture, dependencies, patterns. Run automatically at workflow start. silver:clarify: open-ended framing and decision synthesis from ideas, requirements, and research. Used in silver:feature, silver:ui, and silver:research. silver:scan (gsd-scan): static analysis and code scanning pass. silver:forensics: root-cause investigation for failed sessions, wrong output, and incidents. Use when execution stalls or produces unexpected results.' },
  { page:'Reference', url:'/help/reference/', anchor:'alias-skills',
    title:'Silver Bullet skill aliases — silver:tdd, silver:security, silver:clarify, silver:writing-plans, silver:finishing-branch',
    text:'silver:tdd: hidden internal enforcement wrapper around superpowers:test-driven-development. Activated at the execution boundary before gsd-execute-phase --tdd. silver:security: SENTINEL v2 adversarial security audit. Required in CODE REVIEW step — non-skippable. silver:clarify: alias for the Silver Bullet clarification workflow. Decision-ready framing before planning. silver:writing-plans: alias for superpowers:writing-plans. Spec-to-plan conversion (redirects to /gsd:plan-phase in GSD projects). silver:finishing-branch: alias for superpowers:finishing-a-development-branch. Branch cleanup and merge prep (skipped on main).' },
  { page:'Reference', url:'/help/reference/', anchor:'sb-skills',
    title:'Silver Bullet skills catalog',
    text:'/silver orchestrator entry point /quality-gates /blast-radius /devops-quality-gates /design:accessibility-review UI phases only /deploy-checklist /silver-create-release /testing-strategy /tech-debt /documentation /finishing-a-development-branch main branch skipped /incident-response DevOps Incident Fast Path /silver-forensics /silver:init /silver-add /silver-remove /silver-rem /silver-scan.' },
  { page:'Reference', url:'/help/reference/', anchor:'sb-skills',
  ...
  { page:'Reference', url:'/help/reference/', anchor:'session-log',
    ...
    text:'docs/sessions/YYYY-MM-DD-task-slug.md path written to ~/.claude/.silver-bullet/session-log-path. Sections: Meta Task Approach Skills flagged at discovery Skill gap check post-plan Files changed Skills invoked Agent Teams Autonomous decisions Outcome KNOWLEDGE additions and runtime/cost note when available.' },
  ...
  { page:'Reference', url:'/help/reference/', anchor:'temp-files',
    ...
    text:'~/.claude/.silver-bullet/mode interactive or autonomous. ~/.claude/.silver-bullet/session-log-path current session log. ~/.claude/.silver-bullet/trivial legacy compatibility marker for trivial work. Use /silver:fast instead. ~/.claude/.silver-bullet/session-init session init done sentinel. ~/.claude/.silver-bullet/timeout timeout sentinel.' },
  { page:'Reference', url:'/help/reference/', anchor:'shortcuts',
    title:'Useful shortcuts and command sequences',
    text:'Start new feature: /gsd:discuss-phase /quality-gates /gsd:plan-phase /gsd:execute-phase. Continue where left off: /gsd:next. Debug: /gsd:debug. Trivial fast path: /silver:fast. Check CI: gh run list. Full finalization: /testing-strategy /documentation /finishing-a-development-branch /deploy-checklist /gsd:ship /create-release.' },
  ...
  { page:'Core Concepts', url:'/help/concepts/', anchor:'spec-driven',
    ...
    text:'Spec-driven development pipeline. Use silver:spec for AI-driven spec elicitation producing canonical SPEC.md with requirements acceptance criteria assumption tracking. silver:ingest for external artifact ingestion from JIRA Figma Google Docs via MCP connectors no custom API code. silver:validate for read-only pre-build gap analysis between SPEC.md and PLAN.md files.' },
  { page:'Core Concepts', url:'/help/concepts/', anchor:'spec-driven',
  ...
  { page:'Core Concepts', url:'/help/concepts/', anchor:'artifact-review',
    ...
    text:'CONTEXT reviewer: 6 QC checks enforcing decisions exist gray areas resolved decision specificity no contradictions deferred ideas separation and runtime discretion context present.' },
  { page:'Core Concepts', url:'/help/concepts/', anchor:'artifact-review',
  ...
  { page:'Core Concepts', url:'/help/concepts/', anchor:'review-analytics',
    ...
    text:'Review analytics. Every review round emits structured metrics to JSON Lines file automatically. Each record captures artifact type review depth round number pass/fail result finding categories and timestamp. Run /silver-review-stats for summary reports: pass rates by artifact type rounds to clean pass finding categories by artifact type.' },
  { page:'Reference', url:'/help/reference/', anchor:'spec-skills',
  ...
  { page:'Dev Workflow', url:'/help/dev-workflow/', anchor:'artifact-review-gate',
    ...
    text:'Step 17.0a: artifact review framework runs applicable SPEC DESIGN REQUIREMENTS ROADMAP CONTEXT RESEARCH INGESTION_MANIFEST UAT reviews as pre-deployment gates. Each must produce two consecutive clean passes. Review depth configurable deep standard quick in .planning/config.json. Step 17.0b: cross-artifact alignment check validates SPEC REQUIREMENTS ROADMAP DESIGN consistency. DESIGN check skipped if DESIGN.md absent. Misalignment blocks proceeding to CI gate.' },
  ...
  { page:'Concepts', url:'/help/concepts/composable-workflow.html', anchor:'workflow-md-tracking',
    title:'Per-instance workflow tracker — real-time composition state',
    text:'The active per-instance tracker at .planning/workflows/<id>.md is created by FLOW 0 BOOTSTRAP and updated by the supervision loop after each flow. Key fields: flow_log ordered completed flows with exit conditions, phase_iterations per-phase PLAN EXECUTE REVIEW VERIFY loop count, dynamic_insertions flows added mid-composition, autonomous_decisions logged for transparency, deferred_improvements NICE-TO-HAVE findings deferred, next_flow scheduled next flow. The retired WORKFLOW.md single-file model is legacy only.' },
