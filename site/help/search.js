...
var IDX = [
  ...
  { page:'Core Concepts', url:'/help/concepts/', anchor:'enforcement',
    title:'7 enforcement layers — 4 Pre+PostToolUse hooks, 2 GSD hooks, redundant instructions',
    text:'7 enforcement layers: 1 Skill tracker records invocations. 2 Stage enforcer hard stop if phase out of order. 3 Compliance status shows progress on every tool use. 4 Completion audit two-tier: commits and pushes require quality gates; PR creation deploy release require full required skill list. Registers as PreToolUse unbypassable even in bypass-permissions mode. 5 GSD workflow guard detects edits outside /gsd commands. 6 GSD context monitor warns at low token budget. 7 Redundant instructions plus anti-rationalization.' },
