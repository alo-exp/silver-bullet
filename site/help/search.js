...
var IDX = [
  ...
  },
  {
    ...
    "text": "Help Center landing page for Silver Bullet v0.41.0 concepts, getting started, three-host install, capability matrix, software workflow, DevOps workflow, command reference, named workflows, troubleshooting, and search."
  },
  {
    "page": "Core Concepts",
    "url": "/help/concepts/",
  ...
  },
  {
    ...
    "title": "Runtime parity scripts v0.41.0",
  ...
  },
  {
    ...
    "anchor": "config",
    "title": "Configuration",
    "text": "Current .silver-bullet.json includes version 0.41.0, project active_workflow, skills required_planning and required_deploy, all_tracked skills, devops_plugins, release gates, and state paths."
  },
  {
    "page": "Reference",
    "url": "/help/reference/",
