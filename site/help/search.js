...
var IDX = [
  ...
  { page:'Getting Started', url:'/help/getting-started/', anchor:'prerequisites',
    ...
    text:'Required: Claude Code npm install anthropic claude-code. jq brew install jq apt install jq. GSD Get Shit Done npx get-shit-done-cc@latest. Superpowers plugin install obra/superpowers. Recommended: GitHub CLI gh brew install gh. Design Engineering plugins.' },
  ...
  { page:'Core Concepts', url:'/help/concepts/', anchor:'enforcement',
    title:'6 enforcement layers',
    text:'1 Skill tracker records invocations. 2 Stage enforcer hard stop if phase out of order. 3 Compliance status shows progress on every tool use. 4 Completion audit blocks git commit push deploy. 5 Redundant instructions workflow file and CLAUDE.md. 6 Anti-rationalization explicit rules.' },
