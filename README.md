...
[![version](https://img.shields.io/badge/version-v0.43.10-blue)](https://github.com/alo-exp/silver-bullet/releases/tag/v0.43.10)
...
Project-instance artifacts such as `.planning/` and `.claude/`, and
