...
**Location:** `$HOME/.cursor/research_output/continuation_state_[report_id].json`
...
1. Read continuation state: $HOME/.cursor/research_output/continuation_state_[report_id].json
