...
CLAUDE_SETTINGS_HOME="${CLAUDE_SETTINGS_HOME:-${HOME}/.codex}"
...
CLAUDE_SB_PUBLIC_MARKETPLACE_SOURCE="${CLAUDE_SB_PUBLIC_MARKETPLACE_SOURCE:-https://github.com/alo-labs/agent-plugins.git}"
