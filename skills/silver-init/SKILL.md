...
Use the Glob tool to search for:
`${SB_RUNTIME_HOME_ROOT}/plugins/cache/*/product-management/*/upstream/skills/write-spec/SKILL.md`
and `${SB_RUNTIME_HOME_ROOT}/plugins/cache/*/product-management/*/skills/write-spec/SKILL.md`
and `${SB_RUNTIME_HOME_ROOT}/plugins/cache/*/product-management/skills/`
