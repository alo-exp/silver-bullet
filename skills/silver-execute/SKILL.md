...
- deferred items filed through `sb:add`.
...
5. After each wave:
   ...
   - file skipped or deferred work immediately through `sb:add`.
6. If execution fails, stop the phase and route to `sb:debug` or
   `sb:bugfix`; do not mark the phase complete.
