## TC-01 Multi-Workflow Chain Validation (claude)
...
3. Route via /silver:agent-claude or /silver — document WF-SILVER-FEATURE → WF-SILVER-DEVOPS → WF-SILVER-RELEASE multi-workflow chain.
