## TC-02 Dynamic Composition Validation (claude)
...
1. Confirm branch `feature/tc02-observability-runbook`; verify structured JSON logging + correlation_id + README observability runbook.
2. Route via /silver:agent-claude or /silver — document DR-SUBSTITUTE-LEANER-WORKFLOW and DR-PRUNE-SATISFIED-ATOM tailoring (WF-SILVER-FAST lean path).
