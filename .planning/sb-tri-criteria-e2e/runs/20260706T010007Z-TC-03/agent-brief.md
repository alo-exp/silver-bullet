## TC-03 Net-New Workflow Validation (claude)
...
3. Route via /silver:agent-claude or /silver and silver-new-workflow — document NEW-WORKFLOW dispatch and WF-POSTURE-AUDIT artifact.
