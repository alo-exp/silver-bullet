## TC-03 Greenfield Implementation (claude)
...
1. Confirm branch `feature/tri-claude-tc-03-20260706t043536z-tc-03` is checked out.
...
4. **Git commit** all product files on `feature/tri-claude-tc-03-20260706t043536z-tc-03` with a clear message before any reporting.
