## TC-03 Greenfield Implementation (codex)
...
1. Confirm branch `feature/tri-codex-tc-03-20260706t023103z-tc-03` is checked out.
...
4. **Git commit** all product files on `feature/tri-codex-tc-03-20260706t023103z-tc-03` with a clear message before any reporting.
