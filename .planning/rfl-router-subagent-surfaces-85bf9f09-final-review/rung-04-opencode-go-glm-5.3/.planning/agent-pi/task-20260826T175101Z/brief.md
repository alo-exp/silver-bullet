You are on rung 4/11: model=opencode-go/glm-5.3 (OpenCode Go GLM 5.3 via `/silver:agent-pi` / OmniRoute). User-named GLM — do **not** remap to Grok. Never Fast.
...
Write the official report to `./review.md` in this work directory (same file as the absolute path in Tasks item 3). Do not edit either freeze copy.
...
- SHA-256 you hashed for each copy, sizes, byte-identical yes/no (must be `edff7c0c…` / 621101, not `07b98609…`)
