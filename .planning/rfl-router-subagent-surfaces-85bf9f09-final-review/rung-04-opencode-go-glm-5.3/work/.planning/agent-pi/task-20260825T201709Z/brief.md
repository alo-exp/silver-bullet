You are on rung 4/11: model=opencode-go/glm-5.3, reasoning=host-default.
...
3. Write the report ONLY to:
   `.planning/rfl-router-subagent-surfaces-85bf9f09-final-review/rung-04-opencode-go-glm-5.3/review.md`
