You are on rung 3/11: model=opencode-go/qwen3.8-max (OpenCode Go Qwen3.8 Max via `/silver:agent-pi` / OmniRoute). User-named Qwen — do **not** remap to Grok. Never Fast.
...
- Current locked freeze SHA (both copies byte-identical): `d5343ac14c24c23930140ffe39d34dea5ab799fde2e8f200571c5086131029e0` / 621095 bytes
