...
|-------|--------------|--------|-------|
| 95. Agent Bundle Renderer & Layout Scaffold | AGENT-01..02 | Complete | Generated `agents/claude` and `agents/codex` from the canonical `skills/` tree |
| 96. Installer and Package Wiring | AGENT-03..07 | Complete | Codex/Claude installers, package surfaces, aliases |
| 97. Docs and Compatibility Notes | AGENT-08 | Complete | Runtime/bundle layout docs |
| 98. Tests and Verification Harness | AGENT-09 | Complete | Sync/install parity and naming tests |
| 99. Release v0.35.4 | AGENT-10 | Complete | Full verification + live e2e + release |
