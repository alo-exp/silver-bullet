#!/usr/bin/env python3
"""Full Kimi K3 Max native OpenCode review. Hard timeout; no hang on quota."""
...
RETRY = LOGDIR / os.environ.get("RFL_RETRY_SUBDIR", "retry-20260823T2132Z")
OPENCODE = os.environ.get("OPENCODE_BIN", "/Users/shafqat/.opencode/bin/opencode")
PROMPT = (LOGDIR / "prompt.md").read_text(encoding="utf-8")
TIMEOUT_SEC = int(os.environ.get("RFL_OPENCODE_TIMEOUT", "900"))
...
cmd = [
    ...
    "--auto",
    "--title",
    "rfl-aim-rung-05-kimi-k3-max-retry",
    PROMPT,
]
