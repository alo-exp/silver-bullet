#!/usr/bin/env bash
# Codex Round 8 force1516 — manual FORCE batch rows 15 16 @ 20/22 force716 exit.
set -euo pipefail
...
export SB_E2E_SESSION0_SKIP_REASON="codex-r8 force1516 rows 15 16 @ 20/22"
...
ROWS=(15 16)
printf '\n=== codex-r8-force1516 FORCE %s rows %s @ %s fixture %s@%s ===\n' \
