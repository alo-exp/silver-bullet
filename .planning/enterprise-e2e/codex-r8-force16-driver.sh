#!/usr/bin/env bash
# Codex Round 8 force16 — manual FORCE batch row 16 only @ 21/22 force1516 exit.
set -euo pipefail
...
export SB_E2E_SESSION0_SKIP_REASON="codex-r8 force16 row 16 @ 21/22"
...
ROWS=(16)
printf '\n=== codex-r8-force16 FORCE %s rows %s @ %s fixture %s@%s ===\n' \
