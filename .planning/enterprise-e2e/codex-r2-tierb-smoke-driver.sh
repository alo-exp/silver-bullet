#!/usr/bin/env bash
# Round Codex-2 Tier B — live smoke rows 1, 3, 6 (router + feature + fast).
set -euo pipefail
...
export SB_E2E_SESSION0_SKIP_REASON="Round Codex-2 Tier B smoke @ $(git rev-parse --short HEAD)"
...
ROWS=(1 3 6)
printf '\n=== codex-r2-tierb-smoke %s rows %s @ %s fixture %s@%s ===\n' \
