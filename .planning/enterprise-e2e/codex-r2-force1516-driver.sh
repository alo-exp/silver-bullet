#!/usr/bin/env bash
# Round Codex-2 force1516 — FORCE rows 15 16 only @ 20/22 Tier C exit.
set -euo pipefail
...
export SB_E2E_SESSION0_SKIP_REASON="codex-r2 force1516 rows 15 16 @ 20/22 @ $(git rev-parse --short HEAD)"
...
ROWS=(15 16)
printf '\n=== codex-r2-force1516 FORCE %s rows %s @ %s fixture %s@%s ===\n' \
