#!/usr/bin/env bash
# Codex Round 8 force716 — manual FORCE batch rows 7 15 16 @ 19/22 tierbc exit.
set -euo pipefail
...
export SB_E2E_SESSION0_SKIP_REASON="codex-r8 force716 rows 7 15 16 @ 19/22"
...
ROWS=(7 15 16)
printf '\n=== codex-r8-force716 FORCE %s rows %s @ %s fixture %s@%s ===\n' \
