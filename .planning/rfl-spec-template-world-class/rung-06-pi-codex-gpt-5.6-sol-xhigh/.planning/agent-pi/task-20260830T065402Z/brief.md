# Brief — Rung 06 review pass 9 (Pi Codex GPT-5.6 Sol Extra High)

**Rung:** 6 of 8 — **ninth review pass** on this Extra High model (Policy F: Extra High streak is **0** after launcher `--record-rung-review-outcome accept-apply` for pass 8 `R6h-F01` MED; this is consecutive CLEAN attempt **1** on the **post-R6h** freeze). High’s streak of 2 is a **different** `rung-id` (`rung-05-pi-codex-gpt-5.6-sol-high`) and is complete — do **not** re-review High.
...
Pass 1 history is **`review.md`** (CLEAN on pre-R6b SHA `d45ccf6b…`, no `R6-F*`). Pass 2 history is **`review-rerun-2.md`** (NOT CLEAN; `R6b-F01` HIGH). Pass 3 history is **`review-rerun-3.md`** (NOT CLEAN; `R6c-F01` HIGH). Pass 4 history is **`review-rerun-4.md`** (NOT CLEAN; `R6d-F01` HIGH). Pass 5 history is **`review-rerun-5.md`** (CLEAN on post-R6d SHA `1f11eacc…`; no `R6e-F*`). Pass 6 history is **`review-rerun-6.md`** (NOT CLEAN; `R6f-F01` MED; ACCEPT-apply). Pass 7 history is **`review-rerun-7.md`** (CLEAN on post-R6f SHA `f7c632b8…`; no `R6g-F*`; `verify_1-rerun-7.md` PASS; `verify_2-rerun-7.md` PASS; launcher recorded streak **1**). Pass 8 history is **`review-rerun-8.md`** (NOT CLEAN; `R6h-F01` MED; ACCEPT-apply; `verify_1-rerun-8.md` PASS; `verify_2-rerun-8.md` PASS; Policy C ACCEPT-apply; streak reset to **0**). Do **not** overwrite `review.md`, `review-rerun-2.md`, `review-rerun-3.md`, `review-rerun-4.md`, `review-rerun-5.md`, `review-rerun-6.md`, `review-rerun-7.md`, or `review-rerun-8.md`. Write **`review-rerun-9.md`** only.

## Why this pass exists

Extra High pass 8 (`review-rerun-8.md`) was **NOT CLEAN** (`R6h-F01` MED) on pin **`f7c632b8…`**. `verify_1-rerun-8.md` PASS and `verify_2-rerun-8.md` PASS independently sustained that hole. Parent APPLYed R6h-F01. New freeze pin is **`4d0d3684…`**. Policy F Extra High streak is **0** (required **2** consecutive CLEAN on this Extra High model on the **current** freeze before Claude). This is **pass 9** — first CLEAN attempt on the **post-R6h pin**. **New SHA; residual only.** Confirm R6h landed, then hunt residuals. Do **not** rubber-stamp pass 8. Do **not** re-file `R6h-F01` unless a residual defect remains in **this** freeze text.

**Independent residual re-hunt is mandatory.** Do **not** copy `review.md` or `review-rerun-2.md`–`review-rerun-8.md`. Re-read the pinned freeze from scratch. Passes 1–8 are history, not authority. Residual only: do not re-file APPLYed IDs unless a residual defect remains in **this** freeze text. If you find a residual template-contract gap, file it as `R6i-F01+`. If you find none, say **CLEAN** with evidence from **this** pass’s freeze read.

High APPLY history already in this freeze (do not unwind): R5-F01–F03, R5b-F01–F03, R5c-F01–F03, R5e-F01, R5f-F01, R5h-F01, R5i-F01, R5j-F01, R5k-F01. Earlier rungs: R1-F01–F10, R2-F01–F06, R3-F01–F05, R1b-F01–F03. Extra High pass 2 APPLY: **R6b-F01**. Extra High pass 3 APPLY: **R6c-F01**. Extra High pass 4 APPLY: **R6d-F01**. Extra High pass 6 APPLY: **R6f-F01**. Extra High pass 8 APPLY: **R6h-F01**. Extra High pass 1, pass 5, and pass 7 filed **no** new IDs.
...
1. `graphify query "agent-pi invoke gpt-5.6-sol-xhigh AC-nn QC-4 REQ-F30 Wave 1 R6h-F01"` (or a scoped template/kind-pack query) before exploring. Retrieve prior notes via Graphify, not raw agentmemory dumps.
...
For each: ID (`R6i-F01+`), severity HIGH|MED|LOW|NIT, location (heading/wave/pack/kind), evidence quote, why it matters for the **template contract** (or plan, if secondary), suggested freeze-text fix. Then: **CLEAN** or **NOT CLEAN**.
...
- Official review: `.planning/rfl-spec-template-world-class/rung-06-pi-codex-gpt-5.6-sol-xhigh/review-rerun-9.md` only.
- Do **not** overwrite `review.md`. Do **not** overwrite `review-rerun-2.md`. Do **not** overwrite `review-rerun-3.md`. Do **not** overwrite `review-rerun-4.md`. Do **not** overwrite `review-rerun-5.md`. Do **not** overwrite `review-rerun-6.md`. Do **not** overwrite `review-rerun-7.md`. Do **not** overwrite `review-rerun-8.md`. Do **not** overwrite High `rung-05-*` files.
- Do **not** write live `templates/` or `skills/` patches. Freeze-text suggestions belong in `review-rerun-9.md`.
