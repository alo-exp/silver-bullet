#!/usr/bin/env bash
# Pass 11b Claude High Pi launch (fresh after EXIT 124). No set -u. No tee. No PIPESTATUS.
# Never --continue.
...
LOG="$RUNG/logs/review-attempt11b-stdout.txt"
EXITF="$RUNG/logs/review-attempt11b-exit.txt"
