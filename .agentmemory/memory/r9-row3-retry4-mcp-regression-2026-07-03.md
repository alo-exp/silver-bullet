...
- Regression: harness wrote **populated** `~/.claude/mcp-needs-auth-cache.json` (timestamps) instead of **{}**, contradicting mitigation doc; `enterprise_e2e_verify_matrix_mcp_env` called `claude mcp list` which re-filled cache before spawn.
