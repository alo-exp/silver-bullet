#!/usr/bin/env python3
"""
Idempotently merge Silver Bullet hooks from hooks.json into ~/.codex/settings.json.
...
settings_path = os.path.expanduser('~/.codex/settings.json')
...
print('SB hooks registered in ~/.codex/settings.json')
