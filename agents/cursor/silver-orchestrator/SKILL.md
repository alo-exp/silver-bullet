...
1. Read user intent + `$HOME/.cursor/.silver-bullet/orchestrator-directive.json` + `orchestrator.json`
...
Exception: orchestrator runtime state under `$HOME/.cursor/.silver-bullet/` is hook-managed.
