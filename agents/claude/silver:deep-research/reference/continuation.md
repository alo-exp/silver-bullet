...
**Location:** `$HOME/.claude/research_output/continuation_state_[report_id].json`
...
1. Read continuation state: $HOME/.claude/research_output/continuation_state_[report_id].json
