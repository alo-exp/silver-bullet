...
5. Presence of `$HOME/.claude/.silver-bullet/timeout` (was sentinel triggered?)
...
2. Check sentinel artifacts: was `$HOME/.claude/.silver-bullet/timeout` set? What was the last
