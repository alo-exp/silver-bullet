#!/usr/bin/env python3
"""Idempotently merge Silver Bullet hooks from cursor-hooks.json into $HOME/.claude/hooks.json."""
...
settings_path = os.path.join(os.path.expanduser("~"), ".claude", "hooks.json")
...
print("SB hooks registered in $HOME/.claude/hooks.json")
