...
**Cursor orchestrator rule:** On init, copy `templates/cursor-rules/silver-orchestrator.mdc` → `.claude/rules/silver-orchestrator.mdc` (see `references/scaffold-steps.md` §3.2.1).
