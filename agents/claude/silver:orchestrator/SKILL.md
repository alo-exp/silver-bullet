...
1. Read user intent + `$HOME/.claude/.silver-bullet/orchestrator-directive.json` + `orchestrator.json`
...
Exception: orchestrator runtime state under `$HOME/.claude/.silver-bullet/` is hook-managed.
