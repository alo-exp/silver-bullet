# Solution Capability Report: oh-my-pi
...
- The secondary SDLC-plugins market (BMAD, GSD, Superpowers, GitHub Spec Kit, Oh My Pi, Zuvo, SuperClaude, Ruflo/Claude Flow) is the most formidable substitute set for Silver Bullet — these are OSS methodology packs that overlap heavily with SB's skill catalog but lack deterministic gate enforcement and cross-session state.
- Secondary-market SDLC plugins and methodology packs (Zuvo, GSD, Superpowers, BMAD-METHOD, GitHub Spec Kit, SuperClaude, Ruflo / Claude Flow, Oh My Pi) are valid solution-card peers and formidable substitutes for primary APO, even when they do not present themselves as orchestrators.
- BMAD, GSD, Superpowers, Spec Kit, Oh My Pi, Zuvo, SuperClaude, Ruflo listed but no depth on which satisfy ≥3 inclusion criteria. Overlap claims are asserted, not demonstrated.
