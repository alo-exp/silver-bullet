...
AgentHub is a primary-market APO candidate — multi-agent coordination, workflow persistence, specialist routing, cross-session state.

## Evidence-backed notes

- AgentHub is a primary-market APO candidate — multi-agent coordination, workflow persistence, specialist routing, cross-session state.
- AgentHub is a known no-code/low-code agent platform; it likely supports specialist_agents and cross_session_state, but its SDLC process enforcement and deterministic gates are unverified.
...
- Several seeds (e.g., Claude Harness, AgentHub, Conductor) may have changed scope, been renamed, or gone dormant since the category pack was written.
