...
grep -q 'intentionally removed' "$SKILL" && check "documents codex intentionally removed" pass || check "documents codex intentionally removed" fail
...
grep -qF 'agent-claude/invoke' "${REPO_ROOT}/hooks/lib/orchestrator-parent.sh" \
