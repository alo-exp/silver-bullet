...
assert_contains "search index documents Cursor public marketplace package" "public alo-labs/alo-labs-cursor-marketplace Cursor marketplace package" "$REPO_ROOT/site/help/search.js"
