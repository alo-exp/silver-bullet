...
assert_file_exists "Silver Bullet cache alias exposes internal skill source" "$FAKE_SB_INSTALL_ALIAS/skill-source/silver-feature/SKILL.md"
...
assert_file_exists "Installed SB Claude agent bundle synced into package" "$FAKE_SB_PACKAGE_ROOT/agents/claude/silver-scan/SKILL.md"
assert_file_exists "Installed SB Codex agent bundle synced into package" "$FAKE_SB_PACKAGE_ROOT/agents/codex/silver-scan/SKILL.md"
assert_file_exists "Current cache Claude agent bundle synced" "$FAKE_CACHE_ROOT/agents/claude/silver-scan/SKILL.md"
assert_file_exists "Current cache Codex agent bundle synced" "$FAKE_CACHE_ROOT/agents/codex/silver-scan/SKILL.md"
...
assert_file_exists "SB init skill source synced into source bundle" "$REPO_ROOT/plugins/silver-bullet/skill-source/silver-init/SKILL.md"
assert_file_exists "SB ensure-docs skill source synced into source bundle" "$REPO_ROOT/plugins/silver-bullet/skill-source/silver-ensure-docs/SKILL.md"
assert_file_exists "SB feature skill source synced into source bundle" "$REPO_ROOT/plugins/silver-bullet/skill-source/silver-feature/SKILL.md"
assert_file_exists "SB router skill source synced into source bundle" "$REPO_ROOT/plugins/silver-bullet/skill-source/silver/SKILL.md"
assert_file_exists "SB handoff skill source synced into source bundle" "$REPO_ROOT/plugins/silver-bullet/skill-source/silver-handoff/SKILL.md"
assert_file_exists "Progressive review loop skill source synced into source bundle" "$REPO_ROOT/plugins/silver-bullet/skill-source/progressive-review-loop/SKILL.md"
assert_file_exists "Installed progressive review loop skill source synced" "$FAKE_SB_PACKAGE_ROOT/skill-source/progressive-review-loop/SKILL.md"
assert_file_exists "Current cache progressive review loop skill source synced" "$FAKE_CACHE_ROOT/skill-source/progressive-review-loop/SKILL.md"
assert_file_exists "Current alias progressive review loop skill source synced" "$FAKE_SB_INSTALL_ALIAS/skill-source/progressive-review-loop/SKILL.md"
...
assert_contains "SB init skill uses silver prefix" "name: \"silver:init\"" "$REPO_ROOT/plugins/silver-bullet/skill-source/silver-init/SKILL.md"
...
assert_contains "SB ensure-docs skill avoids placeholder doc keys" "using real governed doc keys only" "$REPO_ROOT/plugins/silver-bullet/skill-source/silver-ensure-docs/SKILL.md"
assert_contains "SB feature skill uses silver prefix" "name: \"silver:feature\"" "$REPO_ROOT/plugins/silver-bullet/skill-source/silver-feature/SKILL.md"
assert_contains "SB router skill uses silver name" "name: silver" "$REPO_ROOT/plugins/silver-bullet/skill-source/silver/SKILL.md"
assert_contains "SB handoff skill uses silver prefix" "name: \"silver:handoff\"" "$REPO_ROOT/plugins/silver-bullet/skill-source/silver-handoff/SKILL.md"
assert_contains "Progressive review loop keeps canonical skill name in source bundle" "name: progressive-review-loop" "$REPO_ROOT/plugins/silver-bullet/skill-source/progressive-review-loop/SKILL.md"
assert_contains "Progressive review loop picker title uses Silver prefix in source bundle" "title: \"Silver: Progressive Review Loop\"" "$REPO_ROOT/plugins/silver-bullet/skill-source/progressive-review-loop/SKILL.md"
assert_contains "TDD skill hidden from picker in source bundle" "user-invocable: false" "$REPO_ROOT/plugins/silver-bullet/skill-source/tdd/SKILL.md"
assert_contains "TDD skill delegates to Superpowers TDD in source bundle" "superpowers:test-driven-development" "$REPO_ROOT/plugins/silver-bullet/skill-source/tdd/SKILL.md"
...
assert_contains "Installed SB init skill uses silver prefix" "name: \"silver:init\"" "$FAKE_SB_PACKAGE_ROOT/skill-source/silver-init/SKILL.md"
assert_contains "Installed SB ensure-docs skill uses silver prefix" "name: \"silver:ensure-docs\"" "$FAKE_SB_PACKAGE_ROOT/skill-source/silver-ensure-docs/SKILL.md"
assert_contains "Installed SB feature skill uses silver prefix" "name: \"silver:feature\"" "$FAKE_SB_PACKAGE_ROOT/skill-source/silver-feature/SKILL.md"
assert_contains "Installed SB router skill uses silver name" "name: silver" "$FAKE_SB_PACKAGE_ROOT/skill-source/silver/SKILL.md"
...
assert_contains "Installed SB scan Codex agent bundle uses silver prefix" "name: \"silver:scan\"" "$FAKE_CACHE_ROOT/agents/codex/silver-scan/SKILL.md"
assert_contains "Installed SB feature skill wires TDD into execute boundary" "gsd-execute-phase --tdd" "$FAKE_SB_PACKAGE_ROOT/skill-source/silver-feature/SKILL.md"
assert_contains "Installed SB feature skill documents hidden TDD gate" "Internal TDD gate" "$FAKE_SB_PACKAGE_ROOT/skill-source/silver-feature/SKILL.md"
assert_contains "Installed SB UI skill wires TDD into execute boundary" "gsd-execute-phase --tdd" "$FAKE_SB_PACKAGE_ROOT/skill-source/silver-ui/SKILL.md"
assert_contains "Installed SB bugfix skill uses SB TDD wrapper" "Invoke \`tdd\`" "$FAKE_SB_PACKAGE_ROOT/skill-source/silver-bugfix/SKILL.md"
assert_contains "Installed SB bugfix skill executes with TDD flag" "gsd-execute-phase --tdd" "$FAKE_SB_PACKAGE_ROOT/skill-source/silver-bugfix/SKILL.md"
assert_contains "Installed SB bugfix skill resolves packaged workflows helper" 'SB_WORKFLOWS_BIN' "$FAKE_SB_PACKAGE_ROOT/skill-source/silver-bugfix/SKILL.md"
assert_contains "TDD skill hidden from picker in installed package" "user-invocable: false" "$FAKE_SB_PACKAGE_ROOT/skill-source/tdd/SKILL.md"
assert_contains "TDD skill delegates to Superpowers TDD in installed package" "superpowers:test-driven-development" "$FAKE_SB_PACKAGE_ROOT/skill-source/tdd/SKILL.md"
...
assert_file_exists "public-release cache keeps Silver Bullet feature skill source" "$PUBLIC_STALE_CACHE/skill-source/silver-feature/SKILL.md"
...
assert_file_exists "public-release cache alias exposes internal feature skill source" "$PUBLIC_STALE_ALIAS/skill-source/silver-feature/SKILL.md"
assert_file_exists "public-release cache alias exposes internal progressive review loop skill source" "$PUBLIC_STALE_ALIAS/skill-source/progressive-review-loop/SKILL.md"
