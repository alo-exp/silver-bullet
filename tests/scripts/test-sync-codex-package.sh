...
assert_file_exists "Progressive review loop skill available" "$PACKAGE_ROOT/skills/progressive-review-loop/SKILL.md"
assert_file_exists "Progressive review loop OpenAI metadata available" "$PACKAGE_ROOT/skills/progressive-review-loop/agents/openai.yaml"
...
assert_contains "Progressive review loop keeps canonical skill name" "name: progressive-review-loop" "$PACKAGE_ROOT/skills/progressive-review-loop/SKILL.md"
assert_contains "Progressive review loop picker title uses Silver prefix" "title: \"Silver: Progressive Review Loop\"" "$PACKAGE_ROOT/skills/progressive-review-loop/SKILL.md"
