...
<execution_context>
@${SB_RUNTIME_HOME_ROOT}/get-shit-done/workflows/autonomous.md
...
<process>
Execute the autonomous workflow from @${SB_RUNTIME_HOME_ROOT}/get-shit-done/workflows/autonomous.md end-to-end.
