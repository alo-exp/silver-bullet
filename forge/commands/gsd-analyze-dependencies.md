...
<execution_context>
@${SB_RUNTIME_HOME_ROOT}/get-shit-done/workflows/analyze-dependencies.md
</execution_context>
...
<process>
Execute the analyze-dependencies workflow from @${SB_RUNTIME_HOME_ROOT}/get-shit-done/workflows/analyze-dependencies.md end-to-end.
