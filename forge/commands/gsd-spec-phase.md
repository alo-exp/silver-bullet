...
<execution_context>
@${SB_RUNTIME_HOME_ROOT}/get-shit-done/workflows/spec-phase.md
@${SB_RUNTIME_HOME_ROOT}/get-shit-done/templates/spec.md
</execution_context>
...
<process>
Execute the spec-phase workflow from @${SB_RUNTIME_HOME_ROOT}/get-shit-done/workflows/spec-phase.md end-to-end.
