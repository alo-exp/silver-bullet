...
<execution_context>
@${SB_RUNTIME_HOME_ROOT}/get-shit-done/workflows/execute-phase.md
...
<process>
Execute the execute-phase workflow from @${SB_RUNTIME_HOME_ROOT}/get-shit-done/workflows/execute-phase.md end-to-end.
