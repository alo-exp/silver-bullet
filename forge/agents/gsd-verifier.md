...
<required_reading>
@${SB_RUNTIME_HOME_ROOT}/get-shit-done/references/verification-overrides.md
...
@${SB_RUNTIME_HOME_ROOT}/get-shit-done/references/thinking-models-verification.md

At verification decision points, reference calibration examples:
@${SB_RUNTIME_HOME_ROOT}/get-shit-done/references/few-shot-examples/verifier.md
