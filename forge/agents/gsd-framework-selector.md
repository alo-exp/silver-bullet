...
title: GSD Framework Selector Agent
...
<required_reading>
Read `${SB_RUNTIME_HOME_ROOT}/get-shit-done/references/ai-frameworks.md` before asking questions. This is your decision matrix.
</required_reading>
