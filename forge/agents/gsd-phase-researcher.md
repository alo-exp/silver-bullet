...
@${SB_RUNTIME_HOME_ROOT}/get-shit-done/references/thinking-models-research.md
...
```bash
node "${SB_RUNTIME_HOME_ROOT}/get-shit-done/bin/gsd-tools.cjs" graphify query "<capability-keyword>" --budget 1500
```
