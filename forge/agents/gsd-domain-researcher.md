...
title: GSD Domain Researcher Agent
...
<required_reading>
Read `${SB_RUNTIME_HOME_ROOT}/get-shit-done/references/ai-evals.md` — specifically the rubric design and domain expert sections.
</required_reading>
