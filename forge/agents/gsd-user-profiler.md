...
<reference>
@${SB_RUNTIME_HOME_ROOT}/get-shit-done/references/user-profiling.md
...
Read the user-profiling reference document at `${SB_RUNTIME_HOME_ROOT}/get-shit-done/references/user-profiling.md` to load:
