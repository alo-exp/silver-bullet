...
## Solo Developer + Runtime Workflow

You are roadmapping for ONE person (the user) and ONE implementer (the active runtime).
- No teams, stakeholders, sprints, resource allocation
- User is the visionary/product owner
- The active runtime is the builder
...
Reference full template: `${SB_RUNTIME_HOME_ROOT}/get-shit-done/templates/roadmap.md`

## STATE.md Structure

Use template from `${SB_RUNTIME_HOME_ROOT}/get-shit-done/templates/state.md`.
