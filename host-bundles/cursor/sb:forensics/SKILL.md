...
5. Presence of `$HOME/.cursor/.silver-bullet/timeout` (was sentinel triggered?)
...
2. Check sentinel artifacts: was `$HOME/.cursor/.silver-bullet/timeout` set? What was the last
