...
**Contrast with `/silver:agent-cursor`:** Cursor was merged first as a reference sibling host — both coexist. Use **agent-claude** when Cursor TUI is the intended executor; use **agent-cursor** for Cursor CLI. Do not delete or conflate the two.
