...
**Contrast with `/silver:agent-codex`:** Codex was merged first as a reference sibling host — both coexist. Use **agent-claude** when Cursor TUI is the intended executor; use **agent-codex** for Codex CLI. Do not delete or conflate the two.
