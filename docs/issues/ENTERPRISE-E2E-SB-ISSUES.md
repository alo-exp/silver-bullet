...
| E2E-089 | friction | harness/cursor | Retry2 row logs 0–317B (timeout/connection noise); matrix evidence PASS but outcome FAIL; row 20 timeout; parallel codex batch regressed rows 9–10–13–17 outcome files | MEASURE LEDGER_MISMATCH tolerance + row-15 triad REVIEW pass @pending |
