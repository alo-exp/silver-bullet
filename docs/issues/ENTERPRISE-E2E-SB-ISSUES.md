...
| E2E-088 | friction→fixed | outcome/cursor | Post-retry @1800s: 12/22 fail on OUT-HANDOFF-01/OUT-SUPER-01 (3–4), OUT-KM-01 session partial (6–7,12,14–16,18,20), OUT-MEASURE-01 (16), internal gates 21–22 | SB harness: multi-host orchestrator state search, cursor headless worker-completion pass, matrix KM gref pass, STALE measure tolerance, recursive internal-gate verify + row 3/4 seed markers |
