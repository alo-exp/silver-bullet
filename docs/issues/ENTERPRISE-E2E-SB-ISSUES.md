...
| E2E-087 | friction | harness/cursor | `silver-research` row hits `CLAUDE_INTERACTIVE_TIMEOUT` 900s — evidence present but OUT-KM-01/OUT-WORLD-01 fail | pending: raise cursor matrix timeout or per-slug budget |
