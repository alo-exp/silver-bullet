...
| `AF-DECIDE` | decision_research | `templates/orchestrator-workers/DECIDE.md` | `review-research`, `silver-compare`, `silver-deep-research`, `silver-deep-research-multi-ai` |
...
- atomic_flow: `AF-CLARIFY` optional when SPEC.md absent (required as --spec before AF-SPECIFY)
- atomic_flow: `AF-DECIDE` optional
- atomic_flow: `AF-SPECIFY` optional when SPEC.md absent (required compiler after AF-CLARIFY --spec)
...
- Slug: `silver-multi-ai-task`
- Type: `specialized`
- Final intent gate: `INTENT-GATE-DEFAULT`

- atomic_flow: `AF-MULTI-AI-TASK`

### `WF-SILVER-DEEP-RESEARCH-MULTI-AI`

- Slug: `silver-deep-research-multi-ai`
- Type: `precomposed`
- Final intent gate: `INTENT-GATE-DEFAULT`

- atomic_flow: `AF-CLARIFY`
- atomic_flow: `AF-DECIDE` (multi-ai)
- atomic_flow: `AF-MULTI-AI-TASK`
- atomic_flow: `AF-DOCUMENT`
- atomic_flow: `AF-VALIDATE`
...
| `FS-DELEGATE-CLAUDE-LAUNCH` | `silver-agent-claude` | `AF-AGENT-DELEGATE` | `EV-FS-DELEGATE-CLAUDE-LAUNCH` |
| `FS-DELEGATE-CLAUDE-ROUTE` | `silver-agent-claude` | `AF-AGENT-DELEGATE` | `EV-FS-DELEGATE-CLAUDE-ROUTE` |
| `FS-DELEGATE-CODEX-LAUNCH` | `silver-agent-codex` | `AF-AGENT-DELEGATE` | `EV-FS-DELEGATE-CODEX-LAUNCH` |
| `FS-DELEGATE-CODEX-ROUTE` | `silver-agent-codex` | `AF-AGENT-DELEGATE` | `EV-FS-DELEGATE-CODEX-ROUTE` |
| `FS-DELEGATE-CURSOR-LAUNCH` | `silver-agent-cursor` | `AF-AGENT-DELEGATE` | `EV-FS-DELEGATE-CURSOR-LAUNCH` |
| `FS-DELEGATE-CURSOR-ROUTE` | `silver-agent-cursor` | `AF-AGENT-DELEGATE` | `EV-FS-DELEGATE-CURSOR-ROUTE` |
| `FS-DELEGATE-CURSOR-SUBAGENT-POLICY` | `silver-agent-cursor` | `AF-AGENT-DELEGATE` | `EV-FS-DELEGATE-CURSOR-SUBAGENT-POLICY` |
...
| `FS-MULTI-AI-CAPABILITY-PROBE` | `silver-multi-ai-task` | `AF-MULTI-AI-TASK` | `EV-FS-MULTI-AI-CAPABILITY-PROBE` |
| `FS-MULTI-AI-DISPATCH` | `silver-multi-ai-task` | `AF-MULTI-AI-TASK` | `EV-FS-MULTI-AI-DISPATCH` |
| `FS-MULTI-AI-INDEX` | `silver-multi-ai-task` | `AF-MULTI-AI-TASK` | `EV-FS-MULTI-AI-INDEX` |
| `FS-MULTI-AI-RECONCILE` | `silver-multi-ai-task` | `AF-MULTI-AI-TASK` | `EV-FS-MULTI-AI-RECONCILE` |
| `FS-MULTI-AI-RESERVE` | `silver-multi-ai-task` | `AF-MULTI-AI-TASK` | `EV-FS-MULTI-AI-RESERVE` |
| `FS-MULTI-AI-RESOLVE` | `silver-multi-ai-task` | `AF-MULTI-AI-TASK` | `EV-FS-MULTI-AI-RESOLVE` |
...
| `FS-SILVER_COMPARE` | `silver-compare` | `AF-DECIDE` | `EV-FS-SILVER_COMPARE` |
...
| `FS-SILVER_DEEP_RESEARCH_MULTI_AI` | `silver-deep-research-multi-ai` | `AF-DECIDE` | `EV-FS-SILVER_DEEP_RESEARCH_MULTI_AI` |
...
| `FS-SILVER_MULTI_AI_TASK` | `silver-multi-ai-task` | `AF-MULTI-AI-TASK` | `EV-FS-SILVER_MULTI_AI_TASK` |
